        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Monitoring aktivitas akademik, absensi, dan perkembangan siswa
                </p>
            </div>
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div>
                    ...
                    <p class="text-indigo-100 mt-3 max-w-2xl">
                        Kelola kelas, pantau absensi siswa, input nilai,
                        dan lihat perkembangan akademik secara realtime.
                    </p>

                    @if($kelasWali)
                        <div class="mt-4 inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl">
